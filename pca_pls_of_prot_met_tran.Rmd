...
# sPLS Analysis
```{r}
prot_trans.pls <- pls( prot_genotypes,trans_genotypes, ncomp = 6, mode = "regression")
prot_trans.spls <- spls( prot_genotypes,trans_genotypes, ncomp =6, keepX = c(20,20,20), keepY= c(10,10,10), mode = "regression")
tune.pls <- perf(prot_trans.pls, validation = "Mfold", folds = 6, progressBar = FALSE, nrepeat = 50)
...
plotIndiv(prot_trans.spls, comp = 1:2, rep.space= 'Y-variate', group = groups$genotypes,
